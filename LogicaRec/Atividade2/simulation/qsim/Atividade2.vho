...
-- Design Ports Information
-- s	=>  Location: PIN_B2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- a	=>  Location: PIN_D6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- d	=>  Location: PIN_F7,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Atividade2 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \s~0_combout\ = (\b~input_o\ & ((\c~input_o\) # ((\a~input_o\ & \d~input_o\)))) # (!\b~input_o\ & (\a~input_o\ & (\d~input_o\ & \c~input_o\)))
